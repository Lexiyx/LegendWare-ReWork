    ...
    for (auto& hitbox : hitboxes)
    {
        ...
        for (auto& point : current_points)
        {
            if (!record->bot)
            {
                ...
                if (record->side == RESOLVER_ZERO || record->side == RESOLVER_ORIGINAL)
                {
