				...
				tab_start("5", column_2, 0, size_a_x, size_d_y);
				{
					...
					else
					{
						...
						if (g_cfg.antiaim.type[type].desync)
						{
							...
							{
								ImGui::SliderInt(crypt_str("Desync range"), &g_cfg.antiaim.type[type].desync_range, -120 , 120);
								ImGui::SliderInt(crypt_str("Inverted desync range"), &g_cfg.antiaim.type[type].inverted_desync_range, -120 , 120 );
